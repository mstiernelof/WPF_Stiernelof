...
console.log('I will have to work '+newResult+' weeks until I can afford the surgery my kitty needs.');
//This console logs the final result with appropriate supporting text using concatenation (strings + variable)